...
enum item_t {
	...
	ITEM_HASTE_ENCHANT_AID_MAX = 9022,
	ITEM_VIOLET_ML_AID = 9030,
	ITEM_VIOLET_ML_AID_MAX = 9033,
	ITEM_RUBY_ATTACK_AID = 9040,
	ITEM_EMERALD_SKILL_AID = 9041,
	ITEM_SPLASH			= 2019,
	ITEM_POOL			= 2025,
	ITEM_BOW			= 2456,
