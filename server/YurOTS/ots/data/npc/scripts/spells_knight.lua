...
function onCreatureSay(cid, type, msg)
  	...
  	elseif focus == cid then		talk_start = os.clock()		if msgcontains(msg, 'light healing') then
 		...
 		elseif msgcontains(msg, 'brutal strike') or msgcontains(msg, 'exori con') then
  			learnSpell(cid,'exori con',1000)
 		elseif msgcontains(msg, 'whirlwind throw') or msgcontains(msg, 'exori hur') then
  			learnSpell(cid,'exori hur',800)
