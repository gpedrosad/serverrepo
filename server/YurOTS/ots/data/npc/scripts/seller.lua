...
function onCreatureSay(cid, type, msg)
	...
	local state = npcHandleMessage(
		cid,
		msg,
		'Hello, ' .. creatureGetName(cid) .. '! I sell ropes (50gp), shovels (20gp), backpacks (10gp), manafluids (100gp), lifefluids (60gp), fishing rods (100gp) and torches (2gp). I buy vials (10gp).'
	)
